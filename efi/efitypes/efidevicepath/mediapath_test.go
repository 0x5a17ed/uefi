...
func TestHardDriveMediaDevicePath_Notation(t *testing.T) {
	...
	tests := []struct {
		...
		{
			"gpt, first part",
			fields{1, 0x22, 0x2710000, guid.GUID{0x15, 0xE3, 0x9A, 0x00, 0x1D, 0xD2, 0x10, 0x00, 0x8D, 0x7F, 0x00, 0xA0, 0xC9, 0x24, 0x08, 0xFC}, GUIDPartitionFormat, GUIDSignatureType},
